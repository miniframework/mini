 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class mini_tool_registry extends ArrayObject
{
    /**
     * Class name of the singleton registry object.
     * @var string
     */
    private static $_registryClassName = 'mini_tool_registry';
     ...
     */
    public static function setInstance(mini_tool_Registry $registry)
    {
        if (self::$_registry !== null) {
     ...
     */
    public static function setClassName($registryClassName = 'mini_tool_registry')
    {
        if (self::$_registry !== null) {
            throw new Exception('Registry is already initialized');
        }
